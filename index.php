		...
		<div class="tabla_principal">
			...
			<form method="post" action="submited.php">
				<fieldset>
					...
					Interior:* <input id="interior" id="interior" name="interior" type="number" required>
					Colonia:* <input name="colonia" id="colonia" type="text" required>
					<br><br>
					Telefono:* <input type="tel" name="telefono" id="telefono" maxLength="10" pattern="^\d{10}$" required>
				<div class="centrar"> 
